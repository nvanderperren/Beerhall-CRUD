...
namespace Beerhall_bis.Data
{
    ...
    {
        public static void IniitializeData(ApplicationDbContext dbContext)
        {
            ...
            if (dbContext.Database.EnsureCreated())
            {
                ...
                dbContext.Brewers.Add(duvelMoortgat);
                ...
                dbContext.Brewers.Add(deGraal);

                Brewer deLeeuw = new Brewer("De Leeuw");
                dbContext.Brewers.Add(deLeeuw);
